 ...
 * sender. When the specific email notification is set to true, the user receives those types of
 * email notifications from DocuSign. The user inherits the default account sender email
 * notification settings when the user is created..
 */
@ApiModel(
    description =
...
public class SignerEmailNotifications {
   ...
   */
  @ApiModelProperty(
      value = "When set to **true**, the user receives notifications of carbon copy deliveries.")
   ...
   * @return SignerEmailNotifications
   */
  public SignerEmailNotifications certifiedDeliveryNotification(
   ...
   */
  @ApiModelProperty(
      value = "When set to **true**, the user receives notifications of certified deliveries.")
   ...
   * @return SignerEmailNotifications
   */
  public SignerEmailNotifications commentsOnlyPrivateAndMention(
   ...
   */
  @ApiModelProperty(
      value = "When set to **true**, the user receives notification of document purges.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.agentNotification, signerEmailNotifications.agentNotification)
        && Objects.equals(
            this.carbonCopyNotification, signerEmailNotifications.carbonCopyNotification)
        && Objects.equals(
            this.certifiedDeliveryNotification,
            signerEmailNotifications.certifiedDeliveryNotification)
        && Objects.equals(
            this.commentsOnlyPrivateAndMention,
            signerEmailNotifications.commentsOnlyPrivateAndMention)
        && Objects.equals(this.commentsReceiveAll, signerEmailNotifications.commentsReceiveAll)
        && Objects.equals(
            this.documentMarkupActivation, signerEmailNotifications.documentMarkupActivation)
        ...
        && Objects.equals(
            this.whenSigningGroupMember, signerEmailNotifications.whenSigningGroupMember);
  }
  ...
  public String toString() {
    ...
    sb.append("    carbonCopyNotification: ")
        .append(toIndentedString(carbonCopyNotification))
        .append("\n");
    sb.append("    certifiedDeliveryNotification: ")
        .append(toIndentedString(certifiedDeliveryNotification))
        .append("\n");
    ...
    sb.append("    documentMarkupActivation: ")
        .append(toIndentedString(documentMarkupActivation))
        .append("\n");
    ...
    sb.append("    whenSigningGroupMember: ")
        .append(toIndentedString(whenSigningGroupMember))
        .append("\n");
    sb.append("}");
    return sb.toString();
  }
