...
public class TemplateTabs {
  ...
  /**
   * Specifies a tag on the document where you want the recipient to approve documents in an
   * envelope without placing a signature or initials on the document. If the recipient clicks the
   * Approve tag during the signing process, the recipient is considered to have signed the
   * document. No information is shown on the document for the approval, but it is recorded as a
   * signature in the envelope history..
   *
   * @return approveTabs
   */
  @ApiModelProperty(
   ...
   * @return TemplateTabs
   */
  public TemplateTabs commissionExpirationTabs(
      java.util.List<CommissionExpiration> commissionExpirationTabs) {
   ...
   * @return TemplateTabs
   */
  public TemplateTabs addCommissionExpirationTabsItem(
      CommissionExpiration commissionExpirationTabsItem) {
  ...
  public void setCommissionExpirationTabs(
      java.util.List<CommissionExpiration> commissionExpirationTabs) {
    this.commissionExpirationTabs = commissionExpirationTabs;
  }
  ...
  /**
   * Specifies a tag on the document where you want the recipient's company name to appear. When
   * getting information that includes this tab type, the original value of the tab when the
  ...
  /**
   * Specifies a tab on the document where the date the document was signed will automatically
   * appear..
   *
  ...
  /**
   * Specifies a tag on the document where you want to give the recipient the option of declining an
   * envelope. If the recipient clicks the Decline tag during the signing process, the envelope is
   * voided..
   *
   * @return declineTabs
   */
  ...
  /**
   * Specifies a location on the document where you want where you want the recipient's email, as
   * entered in the recipient information, to display..
   *
  ...
  /**
   * Specifies a tag on the document where you want the envelope ID for to appear. Recipients cannot
  ...
  /**
   * Specifies tag on a document where you want the recipient's first name to appear. This tag takes
   * the recipient's name, as entered in the recipient information, splits it into sections based on
   * spaces and uses the first section as the first name..
   *
  ...
  /**
   * Specifies a tag that is used to add a calculated field to a document. Envelope recipients
   * cannot directly enter information into the tag; the formula tab calculates and displays a new
   * value when changes are made to the reference tag values. The reference tag information and
   * calculation operations are entered in the \"formula\" element. See the [ML:Using the Calculated
   * Fields Feature] quick start guide or [ML:DocuSign Service User Guide] for more information
   * about formulas..
   *
   * @return formulaTabs
   */
   ...
   */
  @ApiModelProperty(
      value = "Specifies a tag on the document where you want the recipient's name to appear.")
  ...
  /**
   * Specifies a tag location in the document at which a recipient will place their initials. The
   * `optional` parameter specifies whether the initials are required or optional..
   *
  ...
  /**
   * Specifies a tag on a document where you want the recipient's last name to appear. This tag
   * takes the recipient's name, as entered in the recipient information, splits it into sections
   * based on spaces and uses the last section as the last name..
   *
   * @return lastNameTabs
   */
  @ApiModelProperty(
  ...
  /**
   * Specify this tag to give your recipient a list of options, presented as a drop-down list, from
  ...
  /**
   * Specifies a location on the document where you want to place additional information, in the
   * form of a note, for a recipient..
   *
   * @return noteTabs
   */
  @ApiModelProperty(
  ...
  /**
   * Specifies a tag on the document when you want the recipient to add supporting documents to an
   * envelope..
   *
  ...
  /**
   * A complex type the contains information about the tag that specifies where the recipient places
   * their signature in the document. The \"optional\" parameter sets if the signature is required
   * or optional. .
   *
   * @return signHereTabs
   */
  ...
  /**
   * Specifies a tag on the document where you want the recipient's title to appear. When getting
   * information that includes this tab type, the original value of the tab when the associated
  ...
  public String toString() {
    ...
    sb.append("    commissionCountyTabs: ")
        .append(toIndentedString(commissionCountyTabs))
        .append("\n");
    sb.append("    commissionExpirationTabs: ")
        .append(toIndentedString(commissionExpirationTabs))
        .append("\n");
    sb.append("    commissionNumberTabs: ")
        .append(toIndentedString(commissionNumberTabs))
        .append("\n");
    sb.append("    commissionStateTabs: ")
        .append(toIndentedString(commissionStateTabs))
        .append("\n");
    ...
    sb.append("    polyLineOverlayTabs: ")
        .append(toIndentedString(polyLineOverlayTabs))
        .append("\n");
    ...
    sb.append("    signerAttachmentTabs: ")
        .append(toIndentedString(signerAttachmentTabs))
        .append("\n");
