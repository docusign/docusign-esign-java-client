 ...
 *
 */
@ApiModel(description = "This tab enables users to strike through the text of a document. The tab is implemented as a line represented as a pair of x and y coordinates.")
...
public class PolyLineOverlay {
   ...
   **/
  @ApiModelProperty(value = "Contains details about the style used for the strike through graphic.")
   ...
   **/
  @ApiModelProperty(value = "Metadata that indicates whether the `overlayType` property is editable. ")
