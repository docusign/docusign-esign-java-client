...
public class BulkEnvelopeStatus {
  ...
  /**
   * Specifies an identifier which can be used to retrieve a more detailed status of individual bulk
   * recipient batches..
   *
   * @return batchId
   */
  ...
  public String toString() {
    ...
    sb.append("    bulkEnvelopesBatchUri: ")
        .append(toIndentedString(bulkEnvelopesBatchUri))
        .append("\n");
