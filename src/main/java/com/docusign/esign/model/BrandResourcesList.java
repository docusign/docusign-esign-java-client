...
public class BrandResourcesList {
   ...
   */
  public BrandResourcesList resourcesContentTypes(
      java.util.List<BrandResources> resourcesContentTypes) {
  ...
  public String toString() {
    ...
    sb.append("    resourcesContentTypes: ")
        .append(toIndentedString(resourcesContentTypes))
        .append("\n");
    sb.append("}");
    return sb.toString();
  }
