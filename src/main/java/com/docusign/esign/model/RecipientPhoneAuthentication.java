...
/**
 * A complex type that Contains the elements: * recipMayProvideNumber - Boolean. When set to
 * **true**, the recipient can use whatever phone number they choose. * senderProvidedNumbers -
 * ArrayOfString. A list of phone numbers the recipient can use. * recordVoicePrint - Reserved. *
...
public class RecipientPhoneAuthentication {
   ...
   * @return RecipientPhoneAuthentication
   */
  public RecipientPhoneAuthentication recipMayProvideNumberMetadata(
   ...
   * @return RecipientPhoneAuthentication
   */
  public RecipientPhoneAuthentication recordVoicePrintMetadata(
   ...
   * @return RecipientPhoneAuthentication
   */
  public RecipientPhoneAuthentication senderProvidedNumbers(
      java.util.List<String> senderProvidedNumbers) {
   ...
   * @return RecipientPhoneAuthentication
   */
  public RecipientPhoneAuthentication addSenderProvidedNumbersItem(
      String senderProvidedNumbersItem) {
   ...
   * @return RecipientPhoneAuthentication
   */
  public RecipientPhoneAuthentication senderProvidedNumbersMetadata(
   ...
   * @return RecipientPhoneAuthentication
   */
  public RecipientPhoneAuthentication validateRecipProvidedNumber(
  ...
  public void setValidateRecipProvidedNumberMetadata(
      PropertyMetadata validateRecipProvidedNumberMetadata) {
    this.validateRecipProvidedNumberMetadata = validateRecipProvidedNumberMetadata;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(
            this.recipMayProvideNumber, recipientPhoneAuthentication.recipMayProvideNumber)
        && Objects.equals(
            this.recipMayProvideNumberMetadata,
            recipientPhoneAuthentication.recipMayProvideNumberMetadata)
        && Objects.equals(this.recordVoicePrint, recipientPhoneAuthentication.recordVoicePrint)
        && Objects.equals(
            this.recordVoicePrintMetadata, recipientPhoneAuthentication.recordVoicePrintMetadata)
        && Objects.equals(
            this.senderProvidedNumbers, recipientPhoneAuthentication.senderProvidedNumbers)
        && Objects.equals(
            this.senderProvidedNumbersMetadata,
            recipientPhoneAuthentication.senderProvidedNumbersMetadata)
        && Objects.equals(
            this.validateRecipProvidedNumber,
            recipientPhoneAuthentication.validateRecipProvidedNumber)
        && Objects.equals(
  ...
  public String toString() {
    ...
    sb.append("    recipMayProvideNumber: ")
        .append(toIndentedString(recipMayProvideNumber))
        .append("\n");
    sb.append("    recipMayProvideNumberMetadata: ")
        .append(toIndentedString(recipMayProvideNumberMetadata))
        .append("\n");
    sb.append("    recordVoicePrint: ").append(toIndentedString(recordVoicePrint)).append("\n");
    sb.append("    recordVoicePrintMetadata: ")
        .append(toIndentedString(recordVoicePrintMetadata))
        .append("\n");
    sb.append("    senderProvidedNumbers: ")
        .append(toIndentedString(senderProvidedNumbers))
        .append("\n");
    sb.append("    senderProvidedNumbersMetadata: ")
        .append(toIndentedString(senderProvidedNumbersMetadata))
        .append("\n");
    sb.append("    validateRecipProvidedNumber: ")
        .append(toIndentedString(validateRecipProvidedNumber))
        .append("\n");
    sb.append("    validateRecipProvidedNumberMetadata: ")
        .append(toIndentedString(validateRecipProvidedNumberMetadata))
        .append("\n");
    sb.append("}");
    return sb.toString();
  }
