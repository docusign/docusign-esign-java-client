...
public class Editor implements Serializable {
   ...
   * @return Editor
   **/
  public Editor additionalNotifications(java.util.List<RecipientAdditionalNotification> additionalNotifications) {
   ...
   * @return Editor
   **/
  public Editor addAdditionalNotificationsItem(RecipientAdditionalNotification additionalNotificationsItem) {
   ...
   * @return Editor
   **/
  public Editor autoRespondedReason(String autoRespondedReason) {
   ...
   * @return Editor
   **/
  public Editor bulkSendV2Recipient(String bulkSendV2Recipient) {
   ...
   * @return Editor
   **/
  public Editor consentDetailsList(java.util.List<ConsentDetails> consentDetailsList) {
   ...
   * @return Editor
   **/
  public Editor addConsentDetailsListItem(ConsentDetails consentDetailsListItem) {
   ...
   * @return Editor
   **/
  public Editor addCustomFieldsItem(String customFieldsItem) {
   ...
   * @return Editor
   **/
  public Editor designatorId(String designatorId) {
   ...
   * @return Editor
   **/
  public Editor designatorIdGuid(String designatorIdGuid) {
   ...
   * @return Editor
   **/
  public Editor documentTemplateId(String documentTemplateId) {
   ...
   * @return Editor
   **/
  public Editor addDocumentVisibilityItem(DocumentVisibility documentVisibilityItem) {
   ...
   * @return Editor
   **/
  public Editor identityVerification(RecipientIdentityVerification identityVerification) {
   ...
   * @return Editor
   **/
  public Editor phoneNumber(RecipientPhoneNumber phoneNumber) {
   ...
   * @return Editor
   **/
  public Editor proofFile(RecipientProofFile proofFile) {
   ...
   * @return Editor
   **/
  public Editor recipientAttachments(java.util.List<RecipientAttachment> recipientAttachments) {
   ...
   * @return Editor
   **/
  public Editor addRecipientAttachmentsItem(RecipientAttachment recipientAttachmentsItem) {
   ...
   * @return Editor
   **/
  public Editor addSigningGroupUsersItem(UserInfo signingGroupUsersItem) {
   ...
   * @return Editor
   **/
  public Editor addSocialAuthenticationsItem(SocialAuthentication socialAuthenticationsItem) {
   ...
   * @return Editor
   **/
  public Editor suppressEmails(String suppressEmails) {
   ...
   * @return Editor
   **/
  public Editor webFormRecipientViewId(String webFormRecipientViewId) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.accessCode, editor.accessCode) &&
        ...
        Objects.equals(this.additionalNotifications, editor.additionalNotifications) &&
        Objects.equals(this.allowSystemOverrideForLockedRecipient, editor.allowSystemOverrideForLockedRecipient) &&
        Objects.equals(this.autoRespondedReason, editor.autoRespondedReason) &&
        Objects.equals(this.bulkSendV2Recipient, editor.bulkSendV2Recipient) &&
        Objects.equals(this.clientUserId, editor.clientUserId) &&
        Objects.equals(this.completedCount, editor.completedCount) &&
        Objects.equals(this.consentDetailsList, editor.consentDetailsList) &&
        ...
        Objects.equals(this.designatorId, editor.designatorId) &&
        Objects.equals(this.designatorIdGuid, editor.designatorIdGuid) &&
        Objects.equals(this.documentTemplateId, editor.documentTemplateId) &&
        ...
        Objects.equals(this.identityVerification, editor.identityVerification) &&
        ...
        Objects.equals(this.phoneNumber, editor.phoneNumber) &&
        Objects.equals(this.proofFile, editor.proofFile) &&
        ...
        Objects.equals(this.suppressEmails, editor.suppressEmails) &&
        ...
        Objects.equals(this.webFormRecipientViewId, editor.webFormRecipientViewId);
  }
