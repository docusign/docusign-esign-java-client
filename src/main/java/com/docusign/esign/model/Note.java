 ...
 *
 */
@Schema(description = "A tab that displays additional information, in the form of a note, for the recipient. ")
...
public class Note implements Serializable {
   ...
   * @return Note
   **/
  public Note agreementAttribute(String agreementAttribute) {
   ...
   * @return Note
   **/
  public Note agreementAttributeLocked(String agreementAttributeLocked) {
   ...
   * @return Note
   **/
  public Note anchorCaseSensitiveMetadata(PropertyMetadata anchorCaseSensitiveMetadata) {
   ...
   * @return Note
   **/
  public Note anchorHorizontalAlignmentMetadata(PropertyMetadata anchorHorizontalAlignmentMetadata) {
   ...
   * @return Note
   **/
  public Note anchorIgnoreIfNotPresentMetadata(PropertyMetadata anchorIgnoreIfNotPresentMetadata) {
   ...
   * @return Note
   **/
  public Note anchorMatchWholeWordMetadata(PropertyMetadata anchorMatchWholeWordMetadata) {
   ...
   * @return Note
   **/
  public Note anchorStringMetadata(PropertyMetadata anchorStringMetadata) {
   ...
   * @return Note
   **/
  public Note anchorTabProcessorVersion(String anchorTabProcessorVersion) {
   ...
   * @return Note
   **/
  public Note anchorTabProcessorVersionMetadata(PropertyMetadata anchorTabProcessorVersionMetadata) {
   ...
   * @return Note
   **/
  public Note anchorUnitsMetadata(PropertyMetadata anchorUnitsMetadata) {
   ...
   * @return Note
   **/
  public Note anchorXOffsetMetadata(PropertyMetadata anchorXOffsetMetadata) {
   ...
   * @return Note
   **/
  public Note anchorYOffsetMetadata(PropertyMetadata anchorYOffsetMetadata) {
   ...
   * @return Note
   **/
  public Note boldMetadata(PropertyMetadata boldMetadata) {
   ...
   * @return Note
   **/
  public Note caption(String caption) {
   ...
   * @return Note
   **/
  public Note captionMetadata(PropertyMetadata captionMetadata) {
   ...
   * @return Note
   **/
  public Note conditionalParentLabelMetadata(PropertyMetadata conditionalParentLabelMetadata) {
   ...
   * @return Note
   **/
  public Note conditionalParentValueMetadata(PropertyMetadata conditionalParentValueMetadata) {
   ...
   * @return Note
   **/
  public Note connectedObjectDetails(ConnectedObjectDetails connectedObjectDetails) {
   ...
   * @return Note
   **/
  public Note customTabIdMetadata(PropertyMetadata customTabIdMetadata) {
   ...
   * @return Note
   **/
  public Note documentIdMetadata(PropertyMetadata documentIdMetadata) {
   ...
   * @return Note
   **/
  public Note extensionData(ExtensionData extensionData) {
   ...
   * @return Note
   **/
  public Note fontColorMetadata(PropertyMetadata fontColorMetadata) {
   ...
   * @return Note
   **/
  public Note fontMetadata(PropertyMetadata fontMetadata) {
   ...
   * @return Note
   **/
  public Note fontSizeMetadata(PropertyMetadata fontSizeMetadata) {
   ...
   * @return Note
   **/
  public Note formOrder(String formOrder) {
   ...
   * @return Note
   **/
  public Note formOrderMetadata(PropertyMetadata formOrderMetadata) {
   ...
   * @return Note
   **/
  public Note formPageLabel(String formPageLabel) {
   ...
   * @return Note
   **/
  public Note formPageLabelMetadata(PropertyMetadata formPageLabelMetadata) {
   ...
   * @return Note
   **/
  public Note formPageNumber(String formPageNumber) {
   ...
   * @return Note
   **/
  public Note formPageNumberMetadata(PropertyMetadata formPageNumberMetadata) {
   ...
   * @return Note
   **/
  public Note height(String height) {
    this.height = height;
    return this;
  }
   ...
   * @return Note
   **/
  public Note heightMetadata(PropertyMetadata heightMetadata) {
   ...
   * @return Note
   **/
  public Note italicMetadata(PropertyMetadata italicMetadata) {
   ...
   * @return Note
   **/
  public Note localePolicy(LocalePolicyTab localePolicy) {
   ...
   * @return Note
   **/
  public Note nameMetadata(PropertyMetadata nameMetadata) {
   ...
   * @return Note
   **/
  public Note pageNumberMetadata(PropertyMetadata pageNumberMetadata) {
   ...
   * @return Note
   **/
  public Note recipientIdGuid(String recipientIdGuid) {
   ...
   * @return Note
   **/
  public Note recipientIdGuidMetadata(PropertyMetadata recipientIdGuidMetadata) {
   ...
   * @return Note
   **/
  public Note recipientIdMetadata(PropertyMetadata recipientIdMetadata) {
   ...
   * @return Note
   **/
  public Note sharedMetadata(PropertyMetadata sharedMetadata) {
   ...
   * @return Note
   **/
  public Note source(String source) {
    this.source = source;
    return this;
  }
   ...
   * @return Note
   **/
  public Note statusMetadata(PropertyMetadata statusMetadata) {
   ...
   * @return Note
   **/
  public Note tabFullyQualifiedPath(String tabFullyQualifiedPath) {
   ...
   * @return Note
   **/
  public Note tabGroupLabels(java.util.List<String> tabGroupLabels) {
   ...
   * @return Note
   **/
  public Note addTabGroupLabelsItem(String tabGroupLabelsItem) {
   ...
   * @return Note
   **/
  public Note tabGroupLabelsMetadata(PropertyMetadata tabGroupLabelsMetadata) {
   ...
   * @return Note
   **/
  public Note tabIdMetadata(PropertyMetadata tabIdMetadata) {
   ...
   * @return Note
   **/
  public Note tabLabelMetadata(PropertyMetadata tabLabelMetadata) {
   ...
   * @return Note
   **/
  public Note tabOrderMetadata(PropertyMetadata tabOrderMetadata) {
   ...
   * @return Note
   **/
  public Note tabType(String tabType) {
   ...
   * @return Note
   **/
  public Note tabTypeMetadata(PropertyMetadata tabTypeMetadata) {
   ...
   * @return Note
   **/
  public Note templateLockedMetadata(PropertyMetadata templateLockedMetadata) {
   ...
   * @return Note
   **/
  public Note templateRequiredMetadata(PropertyMetadata templateRequiredMetadata) {
   ...
   * @return Note
   **/
  public Note toolTipMetadata(PropertyMetadata toolTipMetadata) {
   ...
   * @return Note
   **/
  public Note underlineMetadata(PropertyMetadata underlineMetadata) {
   ...
   * @return Note
   **/
  public Note valueMetadata(PropertyMetadata valueMetadata) {
   ...
   * @return Note
   **/
  public Note warningDetails(ErrorDetails warningDetails) {
   ...
   * @return Note
   **/
  public Note width(String width) {
    this.width = width;
    return this;
  }
   ...
   * @return Note
   **/
  public Note widthMetadata(PropertyMetadata widthMetadata) {
   ...
   * @return Note
   **/
  public Note xPositionMetadata(PropertyMetadata xPositionMetadata) {
   ...
   * @return Note
   **/
  public Note yPositionMetadata(PropertyMetadata yPositionMetadata) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Note note = (Note) o;
    return Objects.equals(this.agreementAttribute, note.agreementAttribute) &&
        Objects.equals(this.agreementAttributeLocked, note.agreementAttributeLocked) &&
        Objects.equals(this.anchorAllowWhiteSpaceInCharacters, note.anchorAllowWhiteSpaceInCharacters) &&
        ...
        Objects.equals(this.anchorIgnoreIfNotPresentMetadata, note.anchorIgnoreIfNotPresentMetadata) &&
        Objects.equals(this.anchorMatchWholeWord, note.anchorMatchWholeWord) &&
        Objects.equals(this.anchorMatchWholeWordMetadata, note.anchorMatchWholeWordMetadata) &&
        Objects.equals(this.anchorString, note.anchorString) &&
        Objects.equals(this.anchorStringMetadata, note.anchorStringMetadata) &&
        Objects.equals(this.anchorTabProcessorVersion, note.anchorTabProcessorVersion) &&
        Objects.equals(this.anchorTabProcessorVersionMetadata, note.anchorTabProcessorVersionMetadata) &&
        Objects.equals(this.anchorUnits, note.anchorUnits) &&
        Objects.equals(this.anchorUnitsMetadata, note.anchorUnitsMetadata) &&
        Objects.equals(this.anchorXOffset, note.anchorXOffset) &&
        Objects.equals(this.anchorXOffsetMetadata, note.anchorXOffsetMetadata) &&
        Objects.equals(this.anchorYOffset, note.anchorYOffset) &&
        Objects.equals(this.anchorYOffsetMetadata, note.anchorYOffsetMetadata) &&
        Objects.equals(this.bold, note.bold) &&
        Objects.equals(this.boldMetadata, note.boldMetadata) &&
        Objects.equals(this.caption, note.caption) &&
        Objects.equals(this.captionMetadata, note.captionMetadata) &&
        Objects.equals(this.conditionalParentLabel, note.conditionalParentLabel) &&
        Objects.equals(this.conditionalParentLabelMetadata, note.conditionalParentLabelMetadata) &&
        Objects.equals(this.conditionalParentValue, note.conditionalParentValue) &&
        Objects.equals(this.conditionalParentValueMetadata, note.conditionalParentValueMetadata) &&
        Objects.equals(this.connectedObjectDetails, note.connectedObjectDetails) &&
        Objects.equals(this.customTabId, note.customTabId) &&
        Objects.equals(this.customTabIdMetadata, note.customTabIdMetadata) &&
        Objects.equals(this.documentId, note.documentId) &&
        Objects.equals(this.documentIdMetadata, note.documentIdMetadata) &&
        Objects.equals(this.errorDetails, note.errorDetails) &&
        Objects.equals(this.extensionData, note.extensionData) &&
        Objects.equals(this.font, note.font) &&
        Objects.equals(this.fontColor, note.fontColor) &&
        Objects.equals(this.fontColorMetadata, note.fontColorMetadata) &&
        Objects.equals(this.fontMetadata, note.fontMetadata) &&
        Objects.equals(this.fontSize, note.fontSize) &&
        Objects.equals(this.fontSizeMetadata, note.fontSizeMetadata) &&
        Objects.equals(this.formOrder, note.formOrder) &&
        Objects.equals(this.formOrderMetadata, note.formOrderMetadata) &&
        Objects.equals(this.formPageLabel, note.formPageLabel) &&
        Objects.equals(this.formPageLabelMetadata, note.formPageLabelMetadata) &&
        Objects.equals(this.formPageNumber, note.formPageNumber) &&
        Objects.equals(this.formPageNumberMetadata, note.formPageNumberMetadata) &&
        Objects.equals(this.height, note.height) &&
        Objects.equals(this.heightMetadata, note.heightMetadata) &&
        ...
        Objects.equals(this.pageNumberMetadata, note.pageNumberMetadata) &&
        Objects.equals(this.recipientId, note.recipientId) &&
        Objects.equals(this.recipientIdGuid, note.recipientIdGuid) &&
        Objects.equals(this.recipientIdGuidMetadata, note.recipientIdGuidMetadata) &&
        ...
        Objects.equals(this.source, note.source) &&
        Objects.equals(this.status, note.status) &&
        Objects.equals(this.statusMetadata, note.statusMetadata) &&
        Objects.equals(this.tabFullyQualifiedPath, note.tabFullyQualifiedPath) &&
        Objects.equals(this.tabGroupLabels, note.tabGroupLabels) &&
        Objects.equals(this.tabGroupLabelsMetadata, note.tabGroupLabelsMetadata) &&
        Objects.equals(this.tabId, note.tabId) &&
        Objects.equals(this.tabIdMetadata, note.tabIdMetadata) &&
        Objects.equals(this.tabLabel, note.tabLabel) &&
        Objects.equals(this.tabLabelMetadata, note.tabLabelMetadata) &&
        Objects.equals(this.tabOrder, note.tabOrder) &&
        Objects.equals(this.tabOrderMetadata, note.tabOrderMetadata) &&
        Objects.equals(this.tabType, note.tabType) &&
        Objects.equals(this.tabTypeMetadata, note.tabTypeMetadata) &&
        Objects.equals(this.templateLocked, note.templateLocked) &&
        Objects.equals(this.templateLockedMetadata, note.templateLockedMetadata) &&
        Objects.equals(this.templateRequired, note.templateRequired) &&
        Objects.equals(this.templateRequiredMetadata, note.templateRequiredMetadata) &&
        Objects.equals(this.tooltip, note.tooltip) &&
        Objects.equals(this.toolTipMetadata, note.toolTipMetadata) &&
        Objects.equals(this.underline, note.underline) &&
        Objects.equals(this.underlineMetadata, note.underlineMetadata) &&
        Objects.equals(this.value, note.value) &&
        Objects.equals(this.valueMetadata, note.valueMetadata) &&
        Objects.equals(this.warningDetails, note.warningDetails) &&
        Objects.equals(this.width, note.width) &&
        Objects.equals(this.widthMetadata, note.widthMetadata) &&
        Objects.equals(this.xPosition, note.xPosition) &&
        Objects.equals(this.xPositionMetadata, note.xPositionMetadata) &&
        Objects.equals(this.yPosition, note.yPosition) &&
        Objects.equals(this.yPositionMetadata, note.yPositionMetadata);
  }
