 ...
 *
 */
@ApiModel(description = "A complex type containing information about a signer recipient. A signer is a recipient who must take action on a document, such as sign, initial, date, or add data to form fields on a document.")
...
public class Signer {
   ...
   * @return proofFile
   **/
  @ApiModelProperty(value = "The proof file of the recipient.")
   ...
   * @return tabs
   **/
  @ApiModelProperty(value = "The tabs to assign to the recipient. [More information](/docs/esign-rest-api/esign101/concepts/tabs/).")
  public Tabs getTabs() {
    return tabs;
  }
