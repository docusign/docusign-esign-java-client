...
public class Signer {
   ...
   * @return Signer
   */
  public Signer additionalNotifications(
   ...
   * @return Signer
   */
  public Signer addAdditionalNotificationsItem(
   ...
   * @return Signer
   */
  public Signer allowSystemOverrideForLockedRecipient(
   ...
   * @return Signer
   */
  public Signer idCheckConfigurationNameMetadata(
   ...
   * @return Signer
   */
  public Signer inheritEmailNotificationConfiguration(
  ...
  /**
   * When set to **true**, this signer is a bulk recipient and the recipient information is
   * contained in a bulk recipient file. Note that when this is true the email and name for the
   * recipient becomes bulk@recipient.com and \"Bulk Recipient\". These fields can not be changed
   ...
   * @return Signer
   */
  public Signer recipientFeatureMetadata(
   ...
   * @return Signer
   */
  public Signer addRecipientFeatureMetadataItem(
   ...
   * @return Signer
   */
  public Signer recipientSignatureProviders(
   ...
   * @return Signer
   */
  public Signer addRecipientSignatureProvidersItem(
  ...
  /**
   * Sets the type of signer certificate required for signing. If left blank, no certificate is
   * required. Only one type of certificate can be set for a signer. The possible values are: *
   * docusign_express - Requires a DocuSign Express certificate. * safe - Requires a SAFE-BioPharma
   * certificate. * open_trust - Requires an OpenTrust certificate. **Important**: There are certain
   * rules and restrictions that must be followed when requiring OpenTrust digital signatures. See
   * [ML:OpenTrust Rules and Restrictions] for more information. .
   *
  ...
  /**
   * When set to **true**, the signer must print, sign, and upload or fax the signed documents to
   * DocuSign..
   *
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.accessCode, signer.accessCode)
        ...
        && Objects.equals(
            ...
            signer.allowSystemOverrideForLockedRecipient)
        ...
        && Objects.equals(
            this.idCheckConfigurationNameMetadata, signer.idCheckConfigurationNameMetadata)
        ...
        && Objects.equals(
            ...
            signer.inheritEmailNotificationConfiguration)
        ...
        && Objects.equals(
            this.lockedRecipientPhoneAuthEditable, signer.lockedRecipientPhoneAuthEditable)
  ...
  public String toString() {
    ...
    sb.append("    isBulkRecipientMetadata: ")
        .append(toIndentedString(isBulkRecipientMetadata))
        .append("\n");
    ...
    sb.append("    notarySignerEmailSent: ")
        .append(toIndentedString(notarySignerEmailSent))
        .append("\n");
