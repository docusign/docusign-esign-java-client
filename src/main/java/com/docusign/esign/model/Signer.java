...
public class Signer {
  ...
  **/
  ...
  public Signer requireSignerCertificate(String requireSignerCertificate) {
   ...
   /**
   * Sets the type of signer certificate required for signing. If left blank, no certificate is required. Only one type of certificate can be set for a signer. The possible values are:  * docusign_express â Requires a DocuSign Express certificate. * safe â Requires a SAFE-BioPharma certificate. * open_trust â Requires an OpenTrust certificate.   **Important**: There are certain rules and restrictions that must be followed when requiring OpenTrust digital signatures. See [ML:OpenTrust Rules and Restrictions] for more information.   
