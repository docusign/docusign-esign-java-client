...
public class Expirations {
  ...
  /**
   * An integer that sets the number of days before envelope expiration that an expiration warning
   * email is sent to the recipient. If set to 0 (zero), no warning email is sent..
   *
   * @return expireWarn
   */
  @ApiModelProperty(
