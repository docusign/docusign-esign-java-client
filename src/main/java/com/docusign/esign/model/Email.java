...
/**
 * A tab that allows the recipient to enter an email address. This is a one-line
 * field that checks that a valid email address is entered. It uses the same
 * parameters as a Text tab, with the validation message and pattern set for
 * email information. When getting information that includes this tab type, the
...
public class Email {
  ...
  public int hashCode() {
    return Objects.hash(anchorAllowWhiteSpaceInCharacters, anchorAllowWhiteSpaceInCharactersMetadata,
        ...
        templateRequiredMetadata, tooltip, toolTipMetadata, underline, underlineMetadata, validationMessage,
        validationMessageMetadata, validationPattern, validationPatternMetadata, value, valueMetadata, width,
