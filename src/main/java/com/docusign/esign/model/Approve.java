 ...
 *
 */
@ApiModel(description = "A tab that allows the recipient to approve documents without placing a signature or initials on the document. ")
...
public class Approve {
   ...
   **/
  @ApiModelProperty(value = "Metadata that indicates whether the `buttonText` property is editable.")
