 ...
 *
 */
@Schema(description = "A tab that displays the recipient's last name. This tab takes the recipient's name as entered in the recipient information, splits it into sections based on spaces and uses the last section as the last name. ")
...
public class LastName implements Serializable {
   ...
   * @return LastName
   **/
  public LastName agreementAttribute(String agreementAttribute) {
   ...
   * @return LastName
   **/
  public LastName agreementAttributeLocked(String agreementAttributeLocked) {
   ...
   * @return LastName
   **/
  public LastName connectedObjectDetails(ConnectedObjectDetails connectedObjectDetails) {
   ...
   * @return LastName
   **/
  public LastName extensionData(ExtensionData extensionData) {
   ...
   * @return LastName
   **/
  public LastName tabFullyQualifiedPath(String tabFullyQualifiedPath) {
   ...
   * @return LastName
   **/
  public LastName warningDetails(ErrorDetails warningDetails) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.agreementAttribute, lastName.agreementAttribute) &&
        Objects.equals(this.agreementAttributeLocked, lastName.agreementAttributeLocked) &&
        Objects.equals(this.anchorAllowWhiteSpaceInCharacters, lastName.anchorAllowWhiteSpaceInCharacters) &&
        ...
        Objects.equals(this.connectedObjectDetails, lastName.connectedObjectDetails) &&
        ...
        Objects.equals(this.extensionData, lastName.extensionData) &&
        ...
        Objects.equals(this.tabFullyQualifiedPath, lastName.tabFullyQualifiedPath) &&
        ...
        Objects.equals(this.warningDetails, lastName.warningDetails) &&
