...
public class NotaryWitness implements Serializable {
   ...
   * @return NotaryWitness
   **/
  public NotaryWitness additionalNotifications(java.util.List<RecipientAdditionalNotification> additionalNotifications) {
   ...
   * @return NotaryWitness
   **/
  public NotaryWitness consentDetailsList(java.util.List<ConsentDetails> consentDetailsList) {
   ...
   * @return NotaryWitness
   **/
  public NotaryWitness customFields(java.util.List<String> customFields) {
   ...
   * @return NotaryWitness
   **/
  public NotaryWitness delegatedTo(java.util.List<DelegationInfo> delegatedTo) {
   ...
   * @return NotaryWitness
   **/
  public NotaryWitness documentVisibility(java.util.List<DocumentVisibility> documentVisibility) {
   ...
   * @return NotaryWitness
   **/
  public NotaryWitness excludedDocuments(java.util.List<String> excludedDocuments) {
   ...
   * @return NotaryWitness
   **/
  public NotaryWitness recipientAttachments(java.util.List<RecipientAttachment> recipientAttachments) {
   ...
   * @return NotaryWitness
   **/
  public NotaryWitness recipientFeatureMetadata(java.util.List<FeatureAvailableMetadata> recipientFeatureMetadata) {
   ...
   * @return NotaryWitness
   **/
  public NotaryWitness recipientSignatureProviders(java.util.List<RecipientSignatureProvider> recipientSignatureProviders) {
   ...
   * @return NotaryWitness
   **/
  public NotaryWitness signingGroupUsers(java.util.List<UserInfo> signingGroupUsers) {
   ...
   * @return NotaryWitness
   **/
  public NotaryWitness socialAuthentications(java.util.List<SocialAuthentication> socialAuthentications) {
