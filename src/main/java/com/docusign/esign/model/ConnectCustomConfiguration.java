...
public class ConnectCustomConfiguration {
  ...
  /**
   * When set to **true**, data is sent to the urlToPublishTo web address. This option can be set to
   * false to stop sending data while maintaining the Connect configuration information..
   *
  ...
  /**
   * When set to **true**, the tracked envelope and recipient events for all users, including users
   * that are added a later time, are sent through Connect..
   *
   * @return allUsers
   */
  @ApiModelProperty(
   ...
   */
  @ApiModelProperty(
      value = "This turns Connect logging on or off. When set to **true**, logging is turned on.")
  ...
  /**
   * A comma separated list of ï¿½Envelopeï¿½ related events that are tracked through Connect. The
   * possible event values are: Sent, Delivered, Completed, Declined, and Voided..
   *
   ...
   * @return ConnectCustomConfiguration
   */
  public ConnectCustomConfiguration includeCertificateOfCompletion(
   ...
   */
  @ApiModelProperty(
      value = "When set to **true**, Connect will send the PDF document along with the update XML.")
   ...
   */
  @ApiModelProperty(
      value = "When set to **true**, Connect will include the voidedReason for voided envelopes.")
   ...
   * @return ConnectCustomConfiguration
   */
  public ConnectCustomConfiguration includeSenderAccountasCustomField(
   ...
   */
  @ApiModelProperty(
      value = "When set to **true**, Connect will include the envelope time zone information.")
  ...
  /**
   * A comma separated list of ï¿½Recipientï¿½ related events that are tracked through Connect. The
   * possible event values are: Sent, Delivered, Completed, Declined, AuthenticationFailed, and
   * AutoResponded..
   *
  ...
  /**
   * When set to **true**, and a publication message fails to be acknowledged, the message goes back
   * into the queue and the system will retry delivery after a successful acknowledgement is
   * received. If the delivery fails a second time, the message is not returned to the queue for
   * sending until Connect receives a successful acknowledgement and it has been at least 24 hours
   * since the previous retry. There is a maximum of ten retries Alternately, you can use Republish
   * Connect Information to manually republish the envelope information..
   *
   ...
   * @return ConnectCustomConfiguration
   */
  public ConnectCustomConfiguration salesforceDocumentsAsContentFiles(
   ...
   * @return ConnectCustomConfiguration
   */
  public ConnectCustomConfiguration senderSelectableItems(
      java.util.List<String> senderSelectableItems) {
   ...
   * @return ConnectCustomConfiguration
   */
  public ConnectCustomConfiguration signMessageWithX509Certificate(
  ...
  /**
   * When set to **true**, Connect messages are signed with an X509 certificate. This provides
  ...
  /**
   * The namespace of the SOAP interface. The namespace value must be set if useSoapInterface is set
   * to true..
   *
  ...
  /**
   * This is the web address and name of your listener or Retrieving Service endpoint. You need to
   * include HTTPS:// in the web address..
   *
  ...
  /**
   * A comma separated list of userIds. This sets the users associated with the tracked envelope and
   * recipient events. When one of the event occurs for a set user, the information is sent through
   * Connect. ###### Note: If allUsers is set to ï¿½falseï¿½ then you must provide a list of user
   * idï¿½s..
   *
   * @return userIds
   */
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(
            this.allowEnvelopePublish, connectCustomConfiguration.allowEnvelopePublish)
        && Objects.equals(
            this.allowSalesforcePublish, connectCustomConfiguration.allowSalesforcePublish)
        ...
        && Objects.equals(
            ...
            connectCustomConfiguration.includeCertificateOfCompletion)
        && Objects.equals(
            this.includeCertSoapHeader, connectCustomConfiguration.includeCertSoapHeader)
        && Objects.equals(
            this.includeDocumentFields, connectCustomConfiguration.includeDocumentFields)
        && Objects.equals(this.includeDocuments, connectCustomConfiguration.includeDocuments)
        && Objects.equals(
            this.includeEnvelopeVoidReason, connectCustomConfiguration.includeEnvelopeVoidReason)
        ...
        && Objects.equals(
            this.includeTimeZoneInformation, connectCustomConfiguration.includeTimeZoneInformation)
        ...
        && Objects.equals(
            this.requiresAcknowledgement, connectCustomConfiguration.requiresAcknowledgement)
        && Objects.equals(
            this.salesforceApiVersion, connectCustomConfiguration.salesforceApiVersion)
        && Objects.equals(this.salesforceAuthcode, connectCustomConfiguration.salesforceAuthcode)
        && Objects.equals(
            this.salesforceCallBackUrl, connectCustomConfiguration.salesforceCallBackUrl)
        && Objects.equals(
        ...
        && Objects.equals(
            this.senderSelectableItems, connectCustomConfiguration.senderSelectableItems)
        && Objects.equals(this.sfObjects, connectCustomConfiguration.sfObjects)
        && Objects.equals(
            this.signMessageWithX509Certificate,
            connectCustomConfiguration.signMessageWithX509Certificate)
  ...
  public String toString() {
    ...
    sb.append("    allowEnvelopePublish: ")
        .append(toIndentedString(allowEnvelopePublish))
        .append("\n");
    sb.append("    allowSalesforcePublish: ")
        .append(toIndentedString(allowSalesforcePublish))
        .append("\n");
    ...
    sb.append("    externalFolderLabel: ")
        .append(toIndentedString(externalFolderLabel))
        .append("\n");
    sb.append("    groupIds: ").append(toIndentedString(groupIds)).append("\n");
    sb.append("    includeCertificateOfCompletion: ")
        .append(toIndentedString(includeCertificateOfCompletion))
        .append("\n");
    sb.append("    includeCertSoapHeader: ")
        .append(toIndentedString(includeCertSoapHeader))
        .append("\n");
    ...
    sb.append("    includeSenderAccountasCustomField: ")
        ...
        .append("\n");
    sb.append("    includeTimeZoneInformation: ")
        .append(toIndentedString(includeTimeZoneInformation))
        .append("\n");
    ...
    sb.append("    requiresAcknowledgement: ")
        .append(toIndentedString(requiresAcknowledgement))
        .append("\n");
    sb.append("    salesforceApiVersion: ")
        .append(toIndentedString(salesforceApiVersion))
        .append("\n");
    sb.append("    salesforceAuthcode: ").append(toIndentedString(salesforceAuthcode)).append("\n");
    sb.append("    salesforceCallBackUrl: ")
        .append(toIndentedString(salesforceCallBackUrl))
        .append("\n");
    sb.append("    salesforceDocumentsAsContentFiles: ")
        .append(toIndentedString(salesforceDocumentsAsContentFiles))
        .append("\n");
    sb.append("    senderOverride: ").append(toIndentedString(senderOverride)).append("\n");
    sb.append("    senderSelectableItems: ")
        .append(toIndentedString(senderSelectableItems))
        .append("\n");
    sb.append("    sfObjects: ").append(toIndentedString(sfObjects)).append("\n");
    sb.append("    signMessageWithX509Certificate: ")
        .append(toIndentedString(signMessageWithX509Certificate))
        .append("\n");
