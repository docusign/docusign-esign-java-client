...
public class UsersApi {
  ...
  public UserSignaturesInformation createSignatures(
    ...
    GenericType<UserSignaturesInformation> localVarReturnType =
        new GenericType<UserSignaturesInformation>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "POST",
        localVarQueryParams,
  ...
  public ContactUpdateResponse deleteContactWithId(String accountId, String contactId)
    ...
    GenericType<ContactUpdateResponse> localVarReturnType =
        new GenericType<ContactUpdateResponse>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "DELETE",
        localVarQueryParams,
  ...
  public CustomSettingsInformation deleteCustomSettings(
    ...
    GenericType<CustomSettingsInformation> localVarReturnType =
        new GenericType<CustomSettingsInformation>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "DELETE",
        localVarQueryParams,
  ...
  public void deleteProfileImage(String accountId, String userId) throws ApiException {
    ...
    if (accountId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'accountId' when calling deleteProfileImage");
    }

    // verify the required parameter 'userId' is set
    if (userId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'userId' when calling deleteProfileImage");
    }
  ...
  /**
   * Removes removes signature information for the specified user.. Removes the signature
   * information for the user. The userId parameter specified in the endpoint must match the
   * authenticated user&#39;s user ID and the user must be a member of the account. The
   * &#x60;signatureId&#x60; accepts a signature ID or a signature name. DocuSign recommends you use
   * signature ID (&#x60;signatureId&#x60;), since some names contain characters that do not
   * properly encode into a URL. If you use the user name, it is likely that the name includes
   * spaces. In that case, URL encode the name before using it in the endpoint. For example encode
  ...
  public void deleteSignature(String accountId, String userId, String signatureId)
    ...
    if (accountId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'accountId' when calling deleteSignature");
    }

    // verify the required parameter 'userId' is set
    if (userId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'userId' when calling deleteSignature");
    }

    // verify the required parameter 'signatureId' is set
    if (signatureId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'signatureId' when calling deleteSignature");
    }
  ...
  /**
   * Deletes the user initials image or the user signature image for the specified user.. Deletes
   * the specified initials image or signature image for the specified user. The function deletes
   * one or the other of the image types, to delete both the initials image and signature image you
   * must call the endpoint twice. The userId parameter specified in the endpoint must match the
   * authenticated user&#39;s user ID and the user must be a member of the account. The
   ...
   * that do not properly encode into a URL. If you use the user name, it is likely that the name
   * includes spaces. In that case, URL encode the name before using it in the endpoint. For example
   ...
   * @throws ApiException if fails to make API call
   */
  public UserSignature deleteSignatureImage(
      String accountId, String userId, String signatureId, String imageType) throws ApiException {
    Object localVarPostBody = "{}";

    // verify the required parameter 'accountId' is set
    if (accountId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'accountId' when calling deleteSignatureImage");
    }

    // verify the required parameter 'userId' is set
    if (userId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'userId' when calling deleteSignatureImage");
    }

    // verify the required parameter 'signatureId' is set
    if (signatureId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'signatureId' when calling deleteSignatureImage");
    }

    // verify the required parameter 'imageType' is set
    if (imageType == null) {
      throw new ApiException(
          400, "Missing the required parameter 'imageType' when calling deleteSignatureImage");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public ContactGetResponse getContactById(
      String accountId, String contactId, UsersApi.GetContactByIdOptions options)
      throws ApiException {
    Object localVarPostBody = "{}";
    ...
    if (accountId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'accountId' when calling getContactById");
    }

    // verify the required parameter 'contactId' is set
    if (contactId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'contactId' when calling getContactById");
    }
    ...
    if (options != null) {
      localVarQueryParams.addAll(
          apiClient.parameterToPair("cloud_provider", options.cloudProvider));
    }
  ...
  /// <summary>
  /// Gets the user information for a specified user. Retrieves the user information for the
  // specified user.   To return additional user information that details the last login date, login
  // status, and the user&#39;s password expiration date, set the optional
  // &#x60;additional_info&#x60; query string parameter to **true**.
  /// </summary>
  ...
  public UserInformation getInformation(
      String accountId, String userId, UsersApi.GetInformationOptions options) throws ApiException {
    Object localVarPostBody = "{}";

    // verify the required parameter 'accountId' is set
    if (accountId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'accountId' when calling getInformation");
    }

    // verify the required parameter 'userId' is set
    if (userId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'userId' when calling getInformation");
    }
  ...
  /**
   * Retrieves the user profile for a specified user.. Retrieves the user profile information, the
   * privacy settings and personal information (address, phone number, etc.) for the specified user.
   * The userId parameter specified in the endpoint must match the authenticated user&#39;s user ID
  ...
  public UserProfile getProfile(String accountId, String userId) throws ApiException {
    ...
    if (accountId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'accountId' when calling getProfile");
    }

    // verify the required parameter 'userId' is set
    if (userId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'userId' when calling getProfile");
    }
  ...
  /// <summary>
  /// Retrieves the user profile image for the specified user. Retrieves the user profile picture
  // for the specified user. The image is returned in the same format as uploaded.  The userId
  // parameter specified in the endpoint must match the authenticated user&#39;s user ID and the
  // user must be a member of the specified account.  If successful, the response returns a 200 - OK
  // and the user profile image.
  /// </summary>
  ...
  public byte[] getProfileImage(
    ...
    if (accountId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'accountId' when calling getProfileImage");
    }

    // verify the required parameter 'userId' is set
    if (userId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'userId' when calling getProfileImage");
    }
  ...
  /**
   * Gets the user account settings for a specified user.. Retrieves a list of the account settings
   * and email notification information for the specified user. The response returns the account
   * setting name/value information and the email notification settings for the specified user. For
   * more information about the different user settings, see the [ML:userSettings list].
   *
   * @param accountId The external account number (int) or account ID Guid. (required)
   * @param userId The user ID of the user being accessed. Generally this is the user ID of the
   *     authenticated user, but if the authenticated user is an Admin on the account, this may be
  ...
  public UserSettingsInformation getSettings(String accountId, String userId) throws ApiException {
    ...
    if (accountId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'accountId' when calling getSettings");
    }

    // verify the required parameter 'userId' is set
    if (userId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'userId' when calling getSettings");
    }
    ...
    GenericType<UserSettingsInformation> localVarReturnType =
        new GenericType<UserSettingsInformation>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "GET",
        localVarQueryParams,
  ...
  /**
   * Gets the user signature information for the specified user.. Retrieves the structure of a
   * single signature with a known signature name. The userId specified in the endpoint must match
   * the authenticated user&#39;s user ID and the user must be a member of the account. The
   * &#x60;signatureId&#x60; parameter accepts a signature ID or a signature name. DocuSign
   * recommends you use signature ID (&#x60;signatureId&#x60;), since some names contain characters
   * that do not properly encode into a URL. If you use the user name, it is likely that the name
   * includes spaces. In that case, URL encode the name before using it in the endpoint. For example
  ...
  public UserSignature getSignature(String accountId, String userId, String signatureId)
    ...
    if (accountId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'accountId' when calling getSignature");
    }

    // verify the required parameter 'userId' is set
    if (userId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'userId' when calling getSignature");
    }

    // verify the required parameter 'signatureId' is set
    if (signatureId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'signatureId' when calling getSignature");
    }
  ...
  // Retrieves the specified initials image or signature image for the specified user. The image is
  // returned in the same format as uploaded. In the request you can specify if the chrome (the
  // added line and identifier around the initial image) is returned with the image.  The userId
  // property specified in the endpoint must match the authenticated user&#39;s user ID and the user
  // must be a member of the account.  The &#x60;signatureId&#x60; parameter accepts a signature ID
  // or a signature name. DocuSign recommends you use signature ID (&#x60;signatureId&#x60;), since
  // some names contain characters that do not properly encode into a URL. If you use the user name,
  // it is likely that the name includes spaces. In that case, URL encode the name before using it
  // in the endpoint.   For example encode \&quot;Bob Smith\&quot; as \&quot;Bob%20Smith\&quot;.
  // ###### Note: Older envelopes might only have chromed images. If getting the non-chromed image
  ...
  public byte[] getSignatureImage(
    ...
    if (accountId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'accountId' when calling getSignatureImage");
    }

    // verify the required parameter 'userId' is set
    if (userId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'userId' when calling getSignatureImage");
    }

    // verify the required parameter 'signatureId' is set
    if (signatureId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'signatureId' when calling getSignatureImage");
    }

    // verify the required parameter 'imageType' is set
    if (imageType == null) {
      throw new ApiException(
          400, "Missing the required parameter 'imageType' when calling getSignatureImage");
    }
  ...
  /**
   * Retrieves the custom user settings for a specified user.. Retrieves a list of custom user
   * settings for a single user. Custom settings provide a flexible way to store and retrieve custom
   * user information that can be used in your own system. ###### Note: Custom user settings are not
   * the same as user account settings. ###Getting Grouped Custom User Settings### If the custom
   * user settings you want to retrieve are grouped, you must include the following information in
   * the header, after Content-Type, in the request:
   * &#x60;X-DocuSign-User-Settings-Key:group_name&#x60; Where the &#x60;group_name&#x60; is your
   * designated name for the group of customer user settings. If the extra header information is not
   * included, only the custom user settings that were added without a group are retrieved.
   *
   * @param accountId The external account number (int) or account ID Guid. (required)
   * @param userId The user ID of the user being accessed. Generally this is the user ID of the
   *     authenticated user, but if the authenticated user is an Admin on the account, this may be
  ...
  public CustomSettingsInformation listCustomSettings(String accountId, String userId)
    ...
    if (accountId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'accountId' when calling listCustomSettings");
    }

    // verify the required parameter 'userId' is set
    if (userId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'userId' when calling listCustomSettings");
    }
  ...
  /// <summary>
  /// Retrieves a list of user signature definitions for a specified user. Retrieves the signature
  // definitions for the specified user.  The userId parameter specified in the endpoint must match
  // the authenticated user&#39;s user ID and the user must be a member of the account.  The
  // &#x60;signatureId&#x60; parameter accepts a signature ID or a signature name. DocuSign
  // recommends you use signature ID (&#x60;signatureId&#x60;), since some names contain characters
  // that do not properly encode into a URL. If you use the user name, it is likely that the name
  // includes spaces. In that case, URL encode the name before using it in the endpoint.   For
  // example encode \&quot;Bob Smith\&quot; as \&quot;Bob%20Smith\&quot;.
  /// </summary>
   ...
   * @return UserSignaturesInformation
   */
  public UserSignaturesInformation listSignatures(String accountId, String userId)
      throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public UserSignaturesInformation listSignatures(
      String accountId, String userId, UsersApi.ListSignaturesOptions options) throws ApiException {
    Object localVarPostBody = "{}";

    // verify the required parameter 'accountId' is set
    if (accountId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'accountId' when calling listSignatures");
    }

    // verify the required parameter 'userId' is set
    if (userId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'userId' when calling listSignatures");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public ContactUpdateResponse postContacts(String accountId, ContactModRequest contactModRequest)
      throws ApiException {
    Object localVarPostBody = contactModRequest;
    ...
    if (accountId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'accountId' when calling postContacts");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public ContactUpdateResponse putContacts(String accountId, ContactModRequest contactModRequest)
      throws ApiException {
    Object localVarPostBody = contactModRequest;
    ...
    if (accountId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'accountId' when calling putContacts");
    }
  ...
  /**
   * Adds or updates custom user settings for the specified user.. Adds or updates custom user
   * settings for the specified user. ###### Note: Custom user settings are not the same as user
   * account settings. Custom settings provide a flexible way to store and retrieve custom user
   * information that you can use in your own system. **Important**: There is a limit on the size
   * for all the custom user settings for a single user. The limit is 4,000 characters, which
   * includes the XML and JSON structure for the settings. ### Grouping Custom User Settings ### You
   * can group custom user settings when adding them. Grouping allows you to retrieve settings that
   * are in a specific group, instead of retrieving all the user custom settings. To group custom
   * user settings, add the following information in the header, after Content-Type:
   * &#x60;X-DocuSign-User-Settings-Key:group_name&#x60; Where the &#x60;group_name&#x60; is your
   * designated name for the group of customer user settings. Grouping is shown in the Example
   * Request Body below. When getting or deleting grouped custom user settings, you must include the
   * extra header information. Grouping custom user settings is not required and if the extra header
   * information is not included, the custom user settings are added normally and can be retrieved
   * or deleted without including the additional header.
   *
   * @param accountId The external account number (int) or account ID Guid. (required)
   * @param userId The user ID of the user being accessed. Generally this is the user ID of the
   *     authenticated user, but if the authenticated user is an Admin on the account, this may be
   ...
   * @throws ApiException if fails to make API call
   */
  public CustomSettingsInformation updateCustomSettings(
      String accountId, String userId, CustomSettingsInformation customSettingsInformation)
      throws ApiException {
    Object localVarPostBody = customSettingsInformation;
    ...
    if (accountId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'accountId' when calling updateCustomSettings");
    }

    // verify the required parameter 'userId' is set
    if (userId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'userId' when calling updateCustomSettings");
    }
  ...
  /**
   * Updates the user profile information for the specified user.. Updates the user&#39;s detail
   * information, profile information, privacy settings, and personal information in the user ID
   * card. You can also change a user&#39;s name by changing the information in the
   * &#x60;userDetails&#x60; property. When changing a user&#39;s name, you can either change the
   * information in the &#x60;userName&#x60; property OR change the information in
   * &#x60;firstName&#x60;, &#x60;middleName&#x60;, &#x60;lastName, suffixName&#x60;, and
   * &#x60;title&#x60; properties. Changes to &#x60;firstName&#x60;, &#x60;middleName&#x60;,
   * &#x60;lastName&#x60;, &#x60;suffixName&#x60;, and &#x60;title&#x60; properties take precedence
   * over changes to the &#x60;userName&#x60; property.
   *
   * @param accountId The external account number (int) or account ID Guid. (required)
   * @param userId The user ID of the user being accessed. Generally this is the user ID of the
   *     authenticated user, but if the authenticated user is an Admin on the account, this may be
   ...
   * @throws ApiException if fails to make API call
   */
  public void updateProfile(String accountId, String userId, UserProfile userProfile)
      throws ApiException {
    ...
    if (accountId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'accountId' when calling updateProfile");
    }

    // verify the required parameter 'userId' is set
    if (userId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'userId' when calling updateProfile");
    }
  ...
  /**
   * Updates the user profile image for a specified user.. Updates the user profile image by
   * uploading an image to the user profile. The supported image formats are: gif, png, jpeg, and
   * bmp. The file must be less than 200K. For best viewing results, DocuSign recommends that the
  ...
  public void updateProfileImage(String accountId, String userId) throws ApiException {
    ...
    if (accountId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'accountId' when calling updateProfileImage");
    }

    // verify the required parameter 'userId' is set
    if (userId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'userId' when calling updateProfileImage");
    }
  ...
  /// <summary>
  /// Updates the user account settings for a specified user. Updates the account settings list and
  // email notification types for the specified user.
  /// </summary>
  ...
  public void updateSettings(
    ...
    if (userId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'userId' when calling updateSettings");
    }
    ...
    if (options != null) {
      localVarQueryParams.addAll(
          apiClient.parameterToPair("allow_all_languages", options.allowAllLanguages));
    }
  ...
  /// <summary>
  /// Updates the user signature for a specified user. Creates, or updates, the signature font and
  // initials for the specified user. When creating a signature, you use this resource to create the
  // signature name and then add the signature and initials images into the signature.  ###### Note:
  // This will also create a default signature for the user when one does not exist.  The userId
  // property specified in the endpoint must match the authenticated user&#39;s user ID and the user
  // must be a member of the account.  The &#x60;signatureId&#x60; parameter accepts a signature ID
  // or a signature name. DocuSign recommends you use signature ID (&#x60;signatureId&#x60;), since
  // some names contain characters that do not properly encode into a URL. If you use the user name,
  ...
  public UserSignature updateSignature(
    ...
    if (accountId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'accountId' when calling updateSignature");
    }

    // verify the required parameter 'userId' is set
    if (userId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'userId' when calling updateSignature");
    }

    // verify the required parameter 'signatureId' is set
    if (signatureId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'signatureId' when calling updateSignature");
    }
  ...
  /// <summary>
  /// Updates the user signature image or user initials image for the specified user. Updates the
  // user signature image or user initials image for the specified user. The supported image formats
  // for this file are: gif, png, jpeg, and bmp. The file must be less than 200K.  The userId
  // property specified in the endpoint must match the authenticated user&#39;s user ID and the user
  // must be a member of the account.  The &#x60;signatureId&#x60; parameter accepts a signature ID
  // or a signature name. DocuSign recommends you use signature ID (&#x60;signatureId&#x60;), since
  // some names contain characters that do not properly encode into a URL. If you use the user name,
   ...
   * @return UserSignature
   */
  public UserSignature updateSignatureImage(
      String accountId, String userId, String signatureId, String imageType) throws ApiException {
  ...
  public UserSignature updateSignatureImage(
    ...
    if (accountId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'accountId' when calling updateSignatureImage");
    }

    // verify the required parameter 'userId' is set
    if (userId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'userId' when calling updateSignatureImage");
    }

    // verify the required parameter 'signatureId' is set
    if (signatureId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'signatureId' when calling updateSignatureImage");
    }

    // verify the required parameter 'imageType' is set
    if (imageType == null) {
      throw new ApiException(
          400, "Missing the required parameter 'imageType' when calling updateSignatureImage");
    }
    ...
    if (options != null) {
      localVarQueryParams.addAll(
          apiClient.parameterToPair("transparent_png", options.transparentPng));
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public UserSignaturesInformation updateSignatures(
      String accountId, String userId, UserSignaturesInformation userSignaturesInformation)
      throws ApiException {
    Object localVarPostBody = userSignaturesInformation;
    ...
    if (accountId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'accountId' when calling updateSignatures");
    }

    // verify the required parameter 'userId' is set
    if (userId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'userId' when calling updateSignatures");
    }
  ...
  public UserInformation updateUser(
      String accountId, String userId, UserInformation userInformation) throws ApiException {
  ...
  public UserInformation updateUser(
    ...
    if (accountId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'accountId' when calling updateUser");
    }
   ...
   * @return UserInformationList
   */
  public UserInformationList updateUsers(String accountId, UserInformationList userInformationList)
      throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public UserInformationList updateUsers(
      String accountId,
