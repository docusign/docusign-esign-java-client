...
public class CloudStorageApi {
  ...
  */
  ...
  public ExternalFolder callList(String accountId, String userId, String serviceId, String folderId, CloudStorageApi.CallListOptions options) throws ApiException {
    ApiResponse<ExternalFolder> localVarResponse = callListWithHttpInfo(accountId, userId, serviceId, folderId, options);
  ...
  public ApiResponse<ExternalFolder > callListWithHttpInfo(String accountId, String userId, String serviceId, String folderId, CloudStorageApi.CallListOptions options) throws ApiException {
    ...
    ExternalFolder localVarResponse = apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarCollectionQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    return new ApiResponse<ExternalFolder>(apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
  ...
  public ApiResponse<CloudStorageProviders > createProviderWithHttpInfo(String accountId, String userId, CloudStorageProviders cloudStorageProviders) throws ApiException {
    ...
    CloudStorageProviders localVarResponse = apiClient.invokeAPI(localVarPath, "POST", localVarQueryParams, localVarCollectionQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    return new ApiResponse<CloudStorageProviders>(apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
  ...
  public ApiResponse<CloudStorageProviders > deleteProviderWithHttpInfo(String accountId, String userId, String serviceId) throws ApiException {
    ...
    GenericType<CloudStorageProviders> localVarReturnType = new GenericType<CloudStorageProviders>() {};
    CloudStorageProviders localVarResponse = apiClient.invokeAPI(localVarPath, "DELETE", localVarQueryParams, localVarCollectionQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    return new ApiResponse<CloudStorageProviders>(apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
  ...
  */
  ...
  public ApiResponse<CloudStorageProviders > getProviderWithHttpInfo(String accountId, String userId, String serviceId, CloudStorageApi.GetProviderOptions options) throws ApiException {
    ...
    GenericType<CloudStorageProviders> localVarReturnType = new GenericType<CloudStorageProviders>() {};
    CloudStorageProviders localVarResponse = apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarCollectionQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    return new ApiResponse<CloudStorageProviders>(apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
  /// <summary>
