...
import com.docusign.esign.model.ViewUrl;
  ...
  this.apiClient = apiClient;
    ...
    * 
      ...
      * @param envelopeId The envelopeId Guid of the envelope being accessed. (required)
      * @param documentId The ID of the document being accessed. (required)
      * @param EnvelopesApi.GetDocumentTabsOptions Options for modifying the method behavior.
      * @return Tabs
    * @throws ApiException if fails to make API call
    */
    ...
    * 
      ...
      * @param envelopeId The envelopeId Guid of the envelope being accessed. (required)
      * @param documentId The ID of the document being accessed. (required)
      * @param EnvelopesApi.GetPagesOptions Options for modifying the method behavior.
      * @return PageImages
    * @throws ApiException if fails to make API call
    */
