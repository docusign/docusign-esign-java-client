...
public class AuthenticationApi {
  ...
  **/
  ...
  public ApiResponse<OauthAccess > getOAuthTokenWithHttpInfo() throws ApiException {
    ...
    OauthAccess localVarResponse = apiClient.invokeAPI(localVarPath, "POST", localVarQueryParams, localVarCollectionQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    return new ApiResponse<OauthAccess>(apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
  ...
  public ApiResponse<UserSocialIdResult > listSocialLoginsWithHttpInfo(String accountId, String userId) throws ApiException {
    ...
    UserSocialIdResult localVarResponse = apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarCollectionQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    return new ApiResponse<UserSocialIdResult>(apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
  /// <summary>
  ...
  */
  ...
  public ApiResponse<LoginInformation > loginWithHttpInfo(AuthenticationApi.LoginOptions options) throws ApiException {
    ...
    LoginInformation localVarResponse = apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarCollectionQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    return new ApiResponse<LoginInformation>(apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
