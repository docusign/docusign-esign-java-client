...
public class TemplatesApi {
  ...
  */
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<BulkRecipientsUpdateResponse > deleteBulkRecipientsWithHttpInfo(String accountId, String templateId, String recipientId) throws ApiException {
    ...
    BulkRecipientsUpdateResponse localVarResponse = apiClient.invokeAPI(localVarPath, "DELETE", localVarQueryParams, localVarCollectionQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    return new ApiResponse<BulkRecipientsUpdateResponse>(apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
  ...
  */
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<BulkRecipientsResponse > listBulkRecipientsWithHttpInfo(String accountId, String templateId, String recipientId, TemplatesApi.ListBulkRecipientsOptions options) throws ApiException {
    Object localVarPostBody = "{}";
    ...
    BulkRecipientsResponse localVarResponse = apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarCollectionQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    return new ApiResponse<BulkRecipientsResponse>(apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
