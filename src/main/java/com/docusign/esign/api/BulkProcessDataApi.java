...
public class BulkProcessDataApi {
  ...
  **/
  ...
  public ApiResponse<Object> createBulkProcessRequestWithHttpInfo(String accountId, String processAction) throws ApiException {
    ...
    String localVarPath = "/v2.1/accounts/{accountId}/bulk_process_data/actions/{processAction}"
  ...
  public ApiResponse<BulkProcessResponse > createBulkProcessRequestToQueueWithHttpInfo(String accountId, String processAction, String bulkProcessListId, BulkProcessRequest bulkProcessRequest) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/v2.1/accounts/{accountId}/bulk_process_data/actions/{processAction}/{bulkProcessListId}"
      .replaceAll("\\{" + "accountId" + "\\}", apiClient.escapeString(accountId.toString()))
      .replaceAll("\\{" + "processAction" + "\\}", apiClient.escapeString(processAction.toString()))
  ...
  public ApiResponse<BulkProcessingListSummaries > getBulkProcessListsWithHttpInfo(String accountId, String processAction) throws ApiException {
    ...
    BulkProcessingListSummaries localVarResponse = apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarCollectionQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
    return new ApiResponse<BulkProcessingListSummaries>(apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
