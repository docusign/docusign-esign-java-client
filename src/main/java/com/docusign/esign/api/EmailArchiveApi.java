...
public class EmailArchiveApi {
  ...
  public void deleteBCCEmailArchive(String accountId, String bccEmailArchiveId)
    ...
    if (accountId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'accountId' when calling deleteBCCEmailArchive");
    }
    ...
    if (bccEmailArchiveId == null) {
      throw new ApiException(
          400,
          "Missing the required parameter 'bccEmailArchiveId' when calling deleteBCCEmailArchive");
    }
  ...
  public BccEmailArchiveHistoryList getBCCEmailArchiveHistoryList(
    ...
    GenericType<BccEmailArchiveHistoryList> localVarReturnType =
        new GenericType<BccEmailArchiveHistoryList>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "GET",
        localVarQueryParams,
