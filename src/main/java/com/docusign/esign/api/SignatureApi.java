...
public class SignatureApi {
  ...
  public CompleteSignHashResponse completeSignHash(CompleteSignRequest completeSignRequest)
    ...
    GenericType<CompleteSignHashResponse> localVarReturnType =
        new GenericType<CompleteSignHashResponse>() {};
   ...
   * @throws ApiException if fails to make API call
   */
  public SignHashSessionInfoResponse signHashSessionInfo(
      SignSessionInfoRequest signSessionInfoRequest) throws ApiException {
    ...
    GenericType<SignHashSessionInfoResponse> localVarReturnType =
        new GenericType<SignHashSessionInfoResponse>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "POST",
        localVarQueryParams,
  ...
  public UpdateTransactionResponse updateTransaction(
      UpdateTransactionRequest updateTransactionRequest) throws ApiException {
    ...
    GenericType<UpdateTransactionResponse> localVarReturnType =
        new GenericType<UpdateTransactionResponse>() {};
    return apiClient.invokeAPI(
        localVarPath,
        "POST",
        localVarQueryParams,
