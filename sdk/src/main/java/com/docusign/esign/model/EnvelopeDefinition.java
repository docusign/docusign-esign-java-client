...
public class EnvelopeDefinition   {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(documents, envelopeDefinition.documents) &&
  ...
  public String toString()  {
    ...
    sb.append("    eventNotification: ").append(StringUtil.toIndentedString(eventNotification)).append("\n");
    sb.append("    brandId: ").append(StringUtil.toIndentedString(brandId)).append("\n");
    sb.append("    allowRecipientRecursion: ").append(StringUtil.toIndentedString(allowRecipientRecursion)).append("\n");
    sb.append("    templateId: ").append(StringUtil.toIndentedString(templateId)).append("\n");
    sb.append("    templateRoles: ").append(StringUtil.toIndentedString(templateRoles)).append("\n");
    sb.append("    compositeTemplates: ").append(StringUtil.toIndentedString(compositeTemplates)).append("\n");
    sb.append("    accessibility: ").append(StringUtil.toIndentedString(accessibility)).append("\n");
